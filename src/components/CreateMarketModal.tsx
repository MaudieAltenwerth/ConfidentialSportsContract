...
const CONTRACT_CREATION_FEE = parseEther('0.02'); // 0.02 ETH in wei
...
const CreateMarketModal: React.FC<CreateMarketModalProps> = ({ isOpen, onClose, onSubmit, address, connect = () => {}, connecting = false, walletError }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Always use MetaMask signer for contract writes (ethers v6 BrowserProvider)
    ...
    try {
      ...
      const minBetWei = parseEther(minBet.toString());
