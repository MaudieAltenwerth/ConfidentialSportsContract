              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold">
                    <span className="text-mint-600 font-bold">{g.users.length} users</span> placed a bet of <span className="text-orange-500 font-bold">{formatEther(BigInt(g.amount.toString()))} ETH</span>
                  </div>
